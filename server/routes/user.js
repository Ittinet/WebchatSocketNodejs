...
const { GetUser, SeachUser, GetCurrentUser, AddFriend, AcceptRequest, GetRequest, DeleteFriend, RejectRequest, GetFirend, GetProfileUser, GetAlreadySent, CancleRequest } = require('../controllers/user')
